    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(choices=[('upload file', 'Uploader File'), ('pengumuman', 'Pengumuman')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitation_token', models.CharField(default='comma-groom-audio-sediment', max_length=100)),
                ('is_blacklisted', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('current_task', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='active', to='hackathon.HackathonTask')),
            ],
            options={
                'verbose_name': 'Tim',
        ...
        migrations.AddField(
            ...
            name='track',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracks', to='hackathon.Track'),
        ),
        migrations.CreateModel(
            name='TaskResponse',
            fields=[
