    ...
    <v-layout justify-center>
      ...
      >
        ...
        <v-card-text v-if="messages.message" class="mt-5">
          <v-alert type="success" class="mb-8" outlined>{{
            messages.message
          }}</v-alert>
          <v-layout justify-center>
            <router-link to="/login/">
              <v-btn color="success" class="mb-5" dark
                >Login ke dashboard</v-btn
              >
            </router-link>
          </v-layout>
        </v-card-text>
        <v-card-text v-if="errors.message" class="mt-5">
          <v-alert type="error" class="mb-8" outlined>{{
            errors.message
          }}</v-alert>
          <v-layout justify-center>
            <router-link to="/">
              <v-btn color="error" class="mb-5" dark
