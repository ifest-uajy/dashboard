<template>
  <v-container>
    ...
    <v-layout justify-center>
      <v-card outlined width="1700" class="card_cloverleaf mb-5 px-5 pt-0 mt-10">
        <v-card-subtitle class="mt-5 pb-0 mb-0">
          <router-link to="/administrasi" class="link_clover">Kembali</router-link>
        </v-card-subtitle>
        <v-card-title class="title_card_cloverleaf mt-2">{{slug.name}}</v-card-title>
        <v-card-subtitle class="subtitle_card_cloverleaf mb-5">Informatics Festival (IFest) #8</v-card-subtitle>
          ...
          >
            <template v-slot:top v-if="dialog">
              <v-dialog v-model="dialog" max-width="1200px">
                <v-card outlined class="card_cloverleaf pb-5 pt-5 px-5">
                          ...
                          <tr v-for="(item, key) in detail.tasks" :key="key">
                            ...
                            <td>
                              <span
                                v-if="item.response.status==='menunggu_verifikasi'"
                              >
                              <v-btn depressed @click="terima(item.response.id)" color="success" small>Terima</v-btn>
                              </span>
                              <span v-else>
                                -
                              </span>
                            ...
                            <td>
                              <span
                                v-if="item.response.status==='menunggu_verifikasi'"
                              >
                              <v-btn depressed @click="tolak(item.response.id)" color="error" small>Tolak</v-btn>
                              </span>
                              <span v-else>
                                -
                              </span>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Ketua Tim", sortable: false, value: "team_leader_name" },
      { text: "Email Ketua Tim", sortable: false, value: "team_leader_email" },
